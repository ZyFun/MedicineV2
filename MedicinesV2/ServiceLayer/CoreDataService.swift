...
extension CoreDataService: ICoreDataService {
    ...
    // TODO: Это лишний метод, сейчас используется для получения всех лекарств и добавлкния уведомлений. Нужно отрефакторить этот функционал. Задача MED-113
    ...
    func fetchRequest(_ entityName: String) -> [NSFetchRequestResult] {
        ...
        // Sort Descriptor
        // TODO: Доработать сортировку в будущем, чтобы пользователь мог сам выбирать направление сортировки и выбирал, по какому параметру производить сортировку. По аналогии с методом fetchedResultsController.
