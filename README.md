...
- отклик на действия в приложении;
- при поиске лекарства теперь так же ищет по действующему веществу и производителю.

Исправления:
- исправлена ошибка, из-за которой плейсхолдер на списке лекарств, скрывался даже если лекарства не были добавлены.
**01.11.2024**
<br/>
*v.1.3.1*
<br/>
Исправления:
- исправлена ошибка, из-за которой на 17 iOS нужно было удерживать кнопку выбора даты, чтобы открылся календарь;
...
- оптимизирова логика работы с уведомлениями.
**17.10.2024**
<br/>
*v.1.3.0*
<br/>
